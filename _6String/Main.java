...
public class Main {
    ...
    private static void exercise1() {
        ...
        String myPresentation = "I'm Margherita I live in Italy";
        System.out.println(myPresentation.toUpperCase());
        System.out.println(myPresentation.toLowerCase());
    }
    ...
    private static void exercise2() {
        ...
        System.out.println(firstName.toUpperCase() + " "
                + middleName.toLowerCase() + " " + lastName.toUpperCase()); // <--- Edit this line
    }
    ...
    private static void exercise3() {
        ...
        String textFrom2Primitives = 3 + " " + true + " " + 3.5;  // <--- Edit this line
