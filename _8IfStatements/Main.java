package javabasics._8IfStatements;
...
public class Main {
    ...
    private static void exercise3() {
        System.out.println("\nExercise 3:");
        double ourDouble = 1.4;
        //Write your code here
        if (ourDouble > 2.5) {
            System.out.println(ourDouble + " is greater than " + 2.5);
        } else {
            double ourDoublePlusOne = ourDouble + 1;
            if (ourDoublePlusOne < 2.5) {
                System.out.println(ourDoublePlusOne + " is still less than " + 2.5);
            } else {
                System.out.println(ourDoublePlusOne + " is now greater than " + 2.5);
            }
        }
    }
