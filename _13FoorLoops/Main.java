package javabasics._13FoorLoops;
...
public class Main {
    ...
    private static void exercise1() {
        ...
        System.out.println("The itemA sum is:" + sumForA);
        ...
        for (Integer iB : itemsB) {
            sumForB+=iB;
        }
        System.out.println("The ItemsB sum is:" + sumForB);
    ...
    private static void exercise2() {
        ...
        // Write code here
        for (int bigger : items) {
            maxNumber = Math.max(maxNumber,bigger);
        }
    ...
    private static void exercise4() {
        ...
        int num = 8;
        for (
                int timesTableCurrentValue = num;
                timesTableCurrentValue <= 80;
                timesTableCurrentValue = timesTableCurrentValue + num
        ) {
            System.out.println(timesTableCurrentValue);
        }
    }
    ...
    private static void exercise5() {
        ...
        for (int timesTableNumber = 1; timesTableNumber <= 10; timesTableNumber++) {
            ...
            for (int num = 1; num <= 10; num++) {
                System.out.println(timesTableNumber * num);
            }
