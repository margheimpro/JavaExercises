...
public class Main {
    ...
    private static void exercise3() {
        ...
        static void printMyLunch() {
            ...
            printMyLunch(myLunchPrice, lunchType, description, weightInGrams);
        }
        
    private static void printMyLunch(double myLunchPrice, String lunchType, String description, int weightInGrams) {
        System.out.println("My lunch cost " + myLunchPrice + " I had a " + lunchType + ", it was: "
