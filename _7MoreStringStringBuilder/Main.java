package javabasics._7MoreStringStringBuilder;
...
public class Main {
    ...
    private static void exercise1() {
        ...
        int ourNumberAsInt = Integer.valueOf(ourNumberStr) + 2;
        System.out.println(ourNumberAsInt);

        String backToString = String.valueOf(ourNumberAsInt);
    ...
    private static void exercise4() {
        ...
        startStrBuilder.append(startInt);
        startStrBuilder.append(startInt);
        //4.4
        double startDouble = Double.valueOf(String.valueOf(startStrBuilder))/3.5;
        //4.5
